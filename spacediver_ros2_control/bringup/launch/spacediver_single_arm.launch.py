...
controller_list = ['feedback_effort_controller',
...
controller_name = controller_list[0]  # Select controller from controller_list
...
spacediver_sdf_xacro_path = os.path.join(
    pkg_dir, "description", "gazebo", "models", "spacediver_single_arm.sdf.xacro")
spacediver_sdf_path = os.path.join(
    pkg_dir, "description", "gazebo", "models", "spacediver_single_arm.sdf")
